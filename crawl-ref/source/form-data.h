...
{
{
    ...
    FormDuration(0, PS_NONE, 0), 0, 0, SIZE_CHARACTER, 10, 0,
    0, 0, 0, true, 0, 0, 3,
...
},
{
    ...
    FormDuration(10, PS_DOUBLE, 60), 0, 5, SIZE_TINY, 10, 21,
    2, 0, 0, true, 10, 10, 5,
...
},
{
    ...
    FormDuration(10, PS_SINGLE, 100), 0, 0, SIZE_CHARACTER, 10, 0,
    0, 0, 0, true, 20, 12, -1,
...
},
{
    ...
    FormDuration(30, PS_DOUBLE, 100), 0, 0, SIZE_LARGE, 12, 15,
    5, 7, 0, true, 0, 10, 12,
...

{
    ...
    DEFAULT_DURATION, 0, 0, SIZE_CHARACTER, 10, 0,
    6, 0, 0, true, 0, 10, 5,
...

{
    ...
    "a filthy swine.",
    EQF_PHYSICAL | EQF_RINGS, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, SIZE_SMALL, 10, 9,
    0, 0, 0, false, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "Teeth", ANIMAL_VERBS,
...

{
    ...
    "",
    EQF_NONE, MR_NO_FLAGS,
    FormDuration(10, PS_DOUBLE, 60), 0, 0, SIZE_CHARACTER, 10, 0,
    0, 0, 0, true, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, true, true,
	"", 0, "", "", "", "",
...

{
    ...
    "a spiny porcupine.",
    EQF_ALL, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, SIZE_TINY, 10, 12,
    0, 0, 0, false, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "Teeth", ANIMAL_VERBS,
    FC_DEFAULT, FC_FORBID, FC_ENABLE, true, false,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    "a lump of jelly.",
    EQF_PHYSICAL | EQF_RINGS, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, SIZE_CHARACTER, 10, 21,
    0, 0, 0, false, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
...

{
    ...
    BAD_DURATION, 0, 0, SIZE_TINY, 10, 30,
...
},
{
	...
	"hiss", 4, "", "", "", "flesh",
	{ MUT_FORM_COLD_BLOODED, MUT_FORM_CONSTRICTION, MUT_FORM_FIRE_RES, MUT_FORM_FLAME_CLOUD }
	},
};
